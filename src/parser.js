	...
	var namespace = S.namespace,
	   ...
	   /**
	     * Converts SPARQL XML to Google JSON
	     * @method getGoogleJsonFromSparqlXml
	     * @protected
	     * @param {Object} sxml The SPARQL XML result set.
	     * @return {Object} Object literal ready for
	     * `google.visualization.DataTable` consumption.
	     * @since 0.2.2
	     */
	    getGoogleJsonFromSparqlXml = function (sxml) {
		if (countXML(sxml)) {
		    return convertXML(sxml);
		}
	    },

	   /**
	     * Converts SPARQL JSON to Google JSON
	     * @method getGoogleJsonFromSparqlJson
	     * @protected
	     * @param {Object} sxml The SPARQL XML result set.
	     * @return {Object} Object literal ready for
	     * `google.visualization.DataTable` consumption.
	     * @since 0.2.2
	     */
	    getGoogleJsonFromSparqlJson = function (sjson) {
		if (countJSON(sjson)) {
		    return convertJSON(sjson);
		}
	    };
	...
	return {
	    ...
	    getGoogleJsonFromSparqlJson: getGoogleJsonFromSparqlJson,
	    getGoogleJsonFromSparqlXml: getGoogleJsonFromSparqlXml
	};
